  ...
  return (
    <div className="flex flex-col h-full bg-slate-50/50">
      ...
      <div className="px-6 py-5 border-b border-slate-200 bg-white shrink-0 shadow-sm z-10 flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-black text-slate-800 tracking-tight">{flow.name}</h2>
          <p className="text-sm text-slate-500 mt-1 font-medium">{flow.description || 'Nicio descriere adăugată.'}</p>
        </div>
